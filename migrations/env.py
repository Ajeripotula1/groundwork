...
#
# Autogenerate is a draft, not a guarantee: always read the migration file
# it produces before running `alembic upgrade head`. It routinely gets
# column/table renames wrong (sees them as a drop + an add, which loses
# data on a real database) and won't always pick the constraint/index names
# you'd choose by hand.
